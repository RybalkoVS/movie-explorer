...
import by.grsu.movieexplorer.data.repository.localMovieRepositoryModule
import by.grsu.movieexplorer.data.repository.remoteMovieRepositoryModule
    ...
    override fun onCreate() {
        ...
        startKoin {
            ...
            modules(
                ...
                remoteMovieRepositoryModule,
                localMovieRepositoryModule,
